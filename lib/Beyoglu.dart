      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            Text(
              "-Muhtarlık etrafı yeşil alanlar Ayni Alibaba Caddesi",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ...
            Text(
              "-Ferit Güleryüz Parkı Kurtoğlu Caddesi, -Recep Tayyip Erdoğan Stadyumu",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ...
            Text(
              "-Abdüsselam Parkı ve etrafı Halıcıoğlu Yanyol Caddesi",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ...
            Text(
              "-Kadımehmet Semt Konağı Bahriye,Aynalıkavak Semt Konağı",
              style: TextStyle(
                fontSize: 20,
                color: Colors.black,
              ),
