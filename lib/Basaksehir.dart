      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 10,),
            Text("BAŞAKŞEHİR TOPLANMA ALANLARI",
              style: TextStyle(
                fontSize: 24,
                color: Colors.green,
              ),
            ...
            Divider(height: 10,color: Colors.black,),
            Text("-Etap Kalyon Park (Metro İstasyonu Yanı)",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ),
            Text("-Koşu Yolu Park (Hürriyet Bulvarı C ve D Blok Tarafı)",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ),
            Text("-579 Ada Park (Necati Coşan Caddesi)",
              style: TextStyle(
                fontSize: 24,
                color: Colors.black,
              ),
            ),
            Text("-804. Park (Başak Pazar Alanı Karşısı)",
              style: TextStyle(
                fontSize: 24,
                color: Colors.black,
              ),
            ),
            Text("-Gül 12 Parkı (Deniz Altı ve Çapa Sokak Kesişimi)",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ),
            Text("-Atatürk Parkı (Bahçeşehir Belediye Hizmet Binası Karşı)",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
