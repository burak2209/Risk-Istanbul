      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            Divider(height: 10,color: Colors.black,),
            Text("-Gündoğdu Nene Hatun Ortaokulu Bahçesi,Fatih Mahalle Parkı",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ),
            Text("-Fatih Cami Bahçesi,Cumhuriyet Köy Parkı",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ),
            Text("-Cumhuriyet Futbol Sahası,Öğümce Stadı",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ),
            Text("-Değirmendere Cami Çevresi,İETT Firuzbey İÖO Durağı",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ),
            Text("-Muhtarlık Binası Önü (0/153),Polonezköy Parkı",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ),
            Text("-Mahmut Şevket Paşa Parkı,Derekenarı Yürüyüş Yolu",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
