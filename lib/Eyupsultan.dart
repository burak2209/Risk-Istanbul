      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 10,),
            Text("EYÜPSULTAN TOPLANMA ALANLARI",
              style: TextStyle(
                fontSize: 24,
                color: Colors.orange,
              ),
            ...
            Divider(height: 10,color: Colors.black,),
            Text("- NECİP FAZIL KISAKÜREK PARK,GÜNEŞ PARKI",
              style: TextStyle(
                fontSize: 20,
                color: Colors.black,
              ),
            ),
            Text("-OSMANLI PARKI ,ŞEHİT HALİT AYDIN PARKI  ",
              style: TextStyle(
                fontSize: 20,
                color: Colors.black,
              ),
            ),
            Text("-ŞEHİT ADİL HIŞT PARKI ,ŞEHİT ALİ BEKDEMİR PARKI ",
              style: TextStyle(
                fontSize: 20,
                color: Colors.black,
              ),
            ),
            Text("- OTAKÇILAR ANADOLU İMAM HATİP LİSESİ YANI BOŞ ALAN",
              style: TextStyle(
                fontSize: 20,
                color: Colors.black,
              ),
            ),
            Text("-GÜRBÜZLER SOKAK FUTBOL SAHASI ,DEDE KORKUT PARKI  ",
              style: TextStyle(
                fontSize: 20,
                color: Colors.black,
              ),
            ),
            Text("- İSTANBUL CAD.KUMLU GEÇİT SK.FEN İŞL.ŞANTİYESİ YANI BOŞARAZİ",
              style: TextStyle(
                fontSize: 20,
                color: Colors.black,
              ),
