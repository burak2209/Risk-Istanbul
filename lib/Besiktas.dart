      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            Text(
              "-Dutluk Parkı ve Hüseyin Aycibin İlköğretim Okulu Bahçesi",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ...
            Text(
              "-Gayrettepe Muhtarlık Yeşil Alanı,Çevre Kültür Parkı",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ...
            Text(
              "-Profesörler Sitesi Yanı Yeşil Alan,Boğaziçi Üniversitesi Sahası",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
            ...
            Text(
              "-Erlangen Parkı,Ballı Sokak Yeşil Alan",
              style: TextStyle(
                fontSize: 24,
                color: Colors.black,
              ),
            ...
            Text(
              "-Boğaziçi Üniversitesi Kampüsü,Levent Huzurevi Parkı",
              style: TextStyle(
                fontSize: 22,
                color: Colors.black,
              ),
